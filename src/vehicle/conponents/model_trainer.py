...
from src.vehicle.utils.common import evaluate_models
from src.vehicle.utils.common import print_evaluated_results
from src.vehicle.utils.common import model_metrics
from src.vehicle.utils.common import save_object
from src.vehicle.conponents.data_transformation import DataTransformation
from src.vehicle.entity import ModelTrainerConfig
import pickle
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            # Read train and test data from the "artifacts" directory
            train = pd.read_csv(os.path.join("artifacts", "data_transformation", "train.csv"))
            test = pd.read_csv(os.path.join("artifacts", "data_transformation", "test.csv"))
